...
def create_app():
    ...
    swagger_config = {
        ...
        "swagger_ui_bundle_js": url_prefix + "/static/swagger-ui-bundle.js",
        "swagger_ui_standalone_preset_js": url_prefix
        + "/static/swagger-ui-standalone-preset.js",
        "swagger_ui_css": url_prefix + "/static/swagger-ui.css",
        # Might as well also load a pinned version of jQuery 2.2.4 (T338094)
        "jquery_js": url_prefix + "/static/jquery.min.js",
    }
    Swagger(
        flask_app,
